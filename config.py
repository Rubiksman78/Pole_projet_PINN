...
parser.add_argument("-dim", help= "dimension of the modelisation", choices=[1, 2, 3], type=int, default=2)
parser.add_argument("-Nb", help = "number of points at the edge", type = int, default=300)
parser.add_argument("-N0", help = "number of initial points", type = int, default=300)
parser.add_argument("-Nr", help = "number of residual points", type = int, default=10000)
...
parser.add_argument("-epochs", help = "number of epochs for simulation",type = int,default=10)
