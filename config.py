...
parser.add_argument("-Nb", help = "number of points at the edge", type = int, default=1000)
parser.add_argument("-N0", help = "number of initial points", type = int, default=1000)
parser.add_argument("-Nr", help = "number of residual points", type = int, default=50000)
...
parser.add_argument("-xmin", help = "lower bound of space simulation",type = float,default=-1.)
parser.add_argument("-xmax", help = "upper bound of space simulation",type = float,default=1.)
parser.add_argument("-epochs", help = "number of epochs for simulation",type = int,default=20000)
